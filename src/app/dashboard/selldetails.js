...
export default function SellDetailsModal({ deal, onClose }) {
  if (!deal) return null;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="mb-4">
          <h3 className="font-semibold mb-1">Offer Information</h3>
          <p className="flex justify-between">
            <span className="text-lightgrey"> Asking Price:</span>
            <span className="text-blue">N90,000,000</span>
          </p>
          <p className="flex justify-between">
            <span className="text-lightgrey">Final Price:</span>
            <span className="text-black"> N70,000,000 </span>
          </p>
        </div>
        ...
        <div className="mb-4">
          ...
          <p className="flex justify-between">
            ...
            <span className="text-blue">#sell3458</span>
          </p>
          <p className="flex justify-between">
            <span className="text-lightgrey">Amount Paid:</span>
            <span className="text-black"> N76,000,000 </span>
          </p>
        </div>
